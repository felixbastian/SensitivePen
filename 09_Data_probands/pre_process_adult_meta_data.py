...
children = pd.read_excel(r"Children/scoring/DataSet#Children.xlsx")
...
if __name__ == "__main__":
    ...
    dates = children['birth_date']

    print(dates)
    new = dates.apply(lambda x: years_between(x,'2022-02-02'))

    new.to_excel('new_dates.xlsx')
