...
public class SensitivePenBehaviour_visu : ObjectMovuino_visu
{
    ...
    [Tooltip("Representation of the inclination : theta.")]
    [SerializeField] private GameObject vertAngle;
    [Tooltip("Representation of the orientation : psi.")]
    ...
    public void FixedUpdate()
    {
        if (onlineMode)
        {
            ...
            //Keep angle between -180° ad 180°
            MovuinoDataProcessing.AngleRange(ref psi);

            //------------ Representation of psi and theta -------------------
            //Graph
            graphData.x = psi;
            ...
            //Separate representation of psi and theta
